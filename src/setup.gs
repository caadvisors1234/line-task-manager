...
function buildGuideSheet_(sheet) {
  ...
  push('(4) 毎朝10時ごろ(土日祝・年末年始を除く)、社内LINEグループへサマリを通知');
  ...
  marks.faq.push(push('Q. LINEの朝の通知はいつ届く？',
    'A. 毎朝10時台に1回届きます(土日・祝日・年末年始12/29〜1/3はお休みです)。通知の「タスク一覧を開く」ボタンを押すと、端末の標準ブラウザでこのファイルが開きます(初回はGoogleへのログインが必要な場合があります)。'));
